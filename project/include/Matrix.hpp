...
class Matrix {
	private:
		double* buffer;
		double* get_matrix_winthout_row_and_col(double* buf, size_t rows_size, size_t cols_size, size_t row, size_t col) const;
		double get_minor(double* buf, size_t cols_size, size_t rows_size, size_t row, size_t col) const;
		Matrix(double* buf);
	public:
